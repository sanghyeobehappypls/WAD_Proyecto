                ...
                <div class="container-fluid text-monospace">
                                        ...
                                        <nav class="navbar navbar-dark bg-warning">
                                                <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu bg-danger text-light">
                                                                <li><a class="dropdown-item" href="registrarEditorial.htm">Registrar aditorial</a></li>
                                                                <li><a class="dropdown-item" href="listaEditoriales.htm">Lista de aditoriales</a></li>
                                                                <li><hr class="dropdown-divider"></li>
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Datos del usuario</h1>
                                </div>
                                ...
                                <div class='row justify-content-center'>
                                        <div class='col-md-12 align-self-center'>
                                                        <table class='table table-hover table-striped table-dark'>
                                                                <tr>
                                                                        <td colspan='2'>
                                                                                <center><img src="${cat.entidad.imagen}" width="300" height="300" /></center>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='id' class='offset-md-3 col-form-label'>ID del usuario</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='id' class='col-xl-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.idUsuario}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='nombre' class='offset-md-3 col-form-label'>Nombre(s) del Usuario</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                ...
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='email' class='offset-md-3 col-form-label text-right'>Correo Eletrónico</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='email' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.email}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='nombreUsuario' class='offset-md-3 col-form-label text-right'>Nombre del usuario</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='nombreUsuario' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.nombreUsuario}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='tipoUsuario' class='offset-md-3 col-form-label text-right'>Tipo de usuario</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='tipoUsuario' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.tipoUsuario}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td colspan='2'>
                                                                                <div class='d-flex flex-xl-row'>
                                                                                        <a href='listaUsuarios.htm' class='btn btn-lg btn-block btn-outline-primary'>Aceptar</a>
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                        </table>

                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Datos de la editorial</h1>
                                </div>
                                                        ...
                                                        <table class='table table-hover table-striped table-dark'>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='id' class='offset-md-3 col-form-label'>ID de la editorial</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='id' class='col-xl-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.idEditorial}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='nombre' class='offset-md-3 col-form-label'>Nombre</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                ...
                                                                <tr>
                                                                        <td colspan='2'>
                                                                                <div class='d-flex flex-xl-row'>
                                                                                        <a href='listaEditoriales.htm' class='btn btn-lg btn-block btn-outline-primary'>Aceptar</a>
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                        </table>

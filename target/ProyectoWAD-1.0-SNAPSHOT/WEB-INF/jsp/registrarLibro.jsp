        ...
        <body id="fondo">
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Registrar libro</h1>
                                </div>
                                                                ...
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="titulo" id="titulo" maxlength="50" required="required" placeholder="El principito" class="form-control col-xl-8" />
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="edicion" id="edicion" maxlength="50" required="required" placeholder="2da. Edición" class="form-control col-xl-8" pattern="[A-Za-z0-9. ]+" />
                                                                        ...
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='contraseña' class='offset-md-3 col-xl-6 col-form-label text-center'>Número de páginas</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="number" name="npaginas" id="npaginas" maxlength="20" required="required" placeholder="1" class="form-control col-xl-8" min="1900" max="2021" />
                                                                                        <div class="invalid-feedback">Debe ingresar un número de páginas válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='contraseña' class='offset-md-3 col-xl-6 col-form-label text-center'>Año de publicación</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="number" name="anio" id="anio" maxlength="20" required="required" placeholder="2020" class="form-control col-xl-8" min="1900" max="2021" />
                                                                                        <div class="invalid-feedback">Debe ingresar un año válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td colspan="2">
                ...
                <script>
                    ...
                    function comprobar()
                    {
                        ...
                        {
                            toastr.success('Usuario registrado correctamente.', 'Registrar Usuario', {
                                progressBar: true
                            });
                            return true;
                        }

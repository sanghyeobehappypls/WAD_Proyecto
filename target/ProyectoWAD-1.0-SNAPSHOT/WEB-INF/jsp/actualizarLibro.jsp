                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Actualizar libro</h1>
                                </div>
                                        ...
                                        <div class='col-md-12 align-self-center'>
                                                        <form class="needs-validation" novalidate method="post" name="formUsuario" id="formUsuario">
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        <input type="hidden" name="idUsuario" id="id" value="${dto.entidad.idLibro}">
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='nombre' class='offset-md-3 col-xl-6 col-form-label text-center'>Título</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="titulo" id="txtNombre" maxlength="50" required="required" placeholder="Nombre(s)" class="form-control col-xl-8" value="${dto.entidad.titulo}" />
                                                                                        <div class="invalid-feedback">Debe ingresar un título válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='apPaterno' class='offset-md-3 col-xl-6 col-form-label text-center'>Edición</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="paterno" id="txtPaterno" maxlength="50" required="required" placeholder="Apellido Paterno" class="form-control col-xl-8" value="${dto.entidad.edicion}" pattern="[A-Za-zÁÉÍÓÚáéíóú]+"/>
                                                                                        <div class="invalid-feedback">Debe ingresar una edición válida</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='apMaterno' class='offset-md-3 col-xl-6 col-form-label text-center'>Autor</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <select id="idAutor" name="idAutor" class="form-control col-xl-8">
                                                                                                <c:forEach var="autor" items="${listaAutores}">
                                                                                                    <c:if test="${dto.entidad.idAutor == autor.entidad.idAutor}">
                                                                                                        <option value="${autor.entidad.idAutor}" selected>${autor.entidad.nombre} ${autor.entidad.paterno} ${autor.entidad.materno} </option>
                                                                                                    </c:if>
                                                                                                    <c:if test="${dto.entidad.idAutor != categoria.entidad.idAutor}">
                                                                                                        <option value="${autor.entidad.idAutor}" >${autor.entidad.nombre} ${autor.entidad.paterno} ${autor.entidad.materno} </option>
                                                                                                    </c:if>
                                                                                                </c:forEach>
                                                                                        </select>
                                                                                        <div class="invalid-feedback">Debe ingresar un autor válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='email' class='offset-md-3 col-xl-6 col-form-label text-center'>Editorial</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <select id="idEditorial" name="idEditorial" class="form-control col-xl-8">
                                                                                                <c:forEach var="editorial" items="${listaEditoriales}">
                                                                                                    <c:if test="${dto.entidad.idEditorial == editorial.entidad.idEditorial}">
                                                                                                        <option value="${editorial.entidad.idEditorial}" selected>${editorial.entidad.nombre}</option>
                                                                                                    </c:if>
                                                                                                    <c:if test="${dto.entidad.idEditorial != editorial.entidad.idEditorial}">
                                                                                                        <option value="${editorial.entidad.idEditorial}" >${editorial.entidad.nombre} </option>
                                                                                                    </c:if>
                                                                                                </c:forEach>
                                                                                        </select>
                                                                                        <div class="invalid-feedback">Debe ingresar una editorial válida</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='nombreUsuario' class='offset-md-3 col-xl-6 col-form-label text-center'>Género</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <select id="idGenero" name="idGenero" class="form-control col-xl-8">
                                                                                                <c:forEach var="genero" items="${listaGeneros}">
                                                                                                    <c:if test="${dto.entidad.idGenero == genero.entidad.idGenero}">
                                                                                                        <option value="${genero.entidad.idGenero}" selected>${genero.entidad.nombre}</option>
                                                                                                    </c:if>
                                                                                                    <c:if test="${dto.entidad.idGenero != genero.entidad.idGenero}">
                                                                                                        <option value="${genero.entidad.idGenero}" >${genero.entidad.nombre}</option>
                                                                                                    </c:if>
                                                                                                </c:forEach>
                                                                                        </select>
                                                                                        <div class="invalid-feedback">Debe ingresar una género válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='password' class='offset-md-3 col-xl-6 col-form-label text-center'>Número de páginas</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="number" name="npaginas" id="txtPassword" maxlength="20" required="required" placeholder="1" class="form-control col-xl-8" min="1" max="1000" value="${dto.entidad.npaginas}"/>
                                                                                        <div class="invalid-feedback">Debe ingresar un número de páginas válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='password' class='offset-md-3 col-xl-6 col-form-label text-center'>Año de edición</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="number" name="anio" id="txtPassword" maxlength="20" required="required" placeholder="2021" class="form-control col-xl-8" min="1900" max="2021" value="${dto.entidad.anio}"/>
                                                                                        <div class="invalid-feedback">Debe ingresar un número de páginas válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                        ...
                                                                                        <div class="sticky-top">
                                                                                                <div class="d-flex flex-xl-row">
                                                                                                        <div class="p-2 col-xl-6">
                                                                                                                <button type="submit" id="btnReg" class="btn btn-lg btn-block btn-outline-success">
                                                                                                                        Actualizar 
                                                                                                                        <i class="fa fa-check"></i>
                                                                                                                </button>
                                                                                                        </div>
                                                                                                        <div class="p-2 col-xl-6">
                                                                                                                <a href ='listaLibros.htm' class='btn btn-lg btn-block btn-outline-danger'>Regresar <i class="fas fa-undo"></i></a>
                                                                                                        </div>

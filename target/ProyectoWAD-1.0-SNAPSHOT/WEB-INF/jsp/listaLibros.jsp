                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Lista de libros</h1>
                                </div>
                                                        ...
                                                        <table class="table table-striped table-hover table-dark">
                                                                ...
                                                                <tbody>
                                                                        <c:forEach var="libros" items="${listaLibros}">
                                                                            <tr>
                                                                                    <td class="text-center align-middle"><c:out value="${libros.entidad.idLibro}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${libros.entidad.titulo}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${libros.entidad.edicion}" /></td>
                                                                                    <c:forEach items="${listaAutores}" var="autores">
                                                                                        <c:if test="${libros.entidad.idAutor == autores.entidad.idAutor}">
                                                                                            <td class="text-center align-middle"><c:out value="${autores.entidad.nombre} ${autores.entidad.paterno} ${autores.entidad.materno}" /></td>
                                                                                        </c:if>
                                                                                    </c:forEach>
                                                                                    <c:forEach items="${listaEditoriales}" var="editoriales">
                                                                                        <c:if test="${libros.entidad.idEditorial == editoriales.entidad.idEditorial}">
                                                                                            <td class="text-center align-middle"><c:out value="${editoriales.entidad.nombre}" /></td>
                                                                                        </c:if>
                                                                                    </c:forEach>
                                                                                    <c:forEach items="${listaGeneros}" var="generos">
                                                                                        <c:if test="${libros.entidad.idGenero == generos.entidad.idGenero}">
                                                                                            <td class="text-center align-middle"><c:out value="${generos.entidad.nombre}" /></td>
                                                                                        </c:if>
                                                                                    </c:forEach>
                                                                                    <c:if test="${tipo == 'Administrador'}">
                                                                                    <td class="text-center align-middle">
                                                                                            <a href="mostrarLibro.htm?id=<c:out value="${libros.entidad.idLibro}" />" class="btn btn-outline-success" title="Ver libro"><i class="fas fa-address-card"></i></a>
                                                                                            <a href="actualizarLibro.htm?id=<c:out value="${libros.entidad.idLibro}" />" class="btn btn-outline-warning" title="Actualizar libro"><i class="fa fa-edit"></i></a>
                                                                                            <a href="eliminarLibro.htm?id=<c:out value="${libros.entidad.idLibro}" />" class="btn btn-outline-danger" title="Eliminar libro" onclick="return eliminar()"><i class="fa fa-trash"></i></a>
                                                                                    </td>
                                                                                    </c:if>
                                                                            </tr>
                                                                        </c:forEach>

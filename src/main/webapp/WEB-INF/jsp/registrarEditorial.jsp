                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Registrar editorial</h1>
                                </div>
                                                                ...
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="nombre" id="nombre" maxlength="50" required="required" placeholder="Nombre" class="form-control col-xl-8" pattern="[A-Za-zÁÉÍÓÚáéíóú ]+"/>
                                                                                ...
                                                                                <td colspan="2">
                                                                                        <div class="sticky-top">
                                                                                                <div class="d-flex flex-xl-row">
                                                                                                        ...
                                                                                                        <div class="p-2 col-xl-6">
                                                                                                                <a href="listaEditoriales.htm" class='btn btn-lg btn-block btn-outline-danger'>Regresar <i class="fas fa-undo"></i></a>
                                                                                                        </div>

                                        ...
                                        <div class='col-md-12 align-self-center'>
                                                <form class="needs-validation" novalidate method="post" name="formUsuario" id="formUsuario" enctype="multipart/form-data">
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        <input type="hidden" name="idUsuario" id="id" value="${dto.entidad.idUsuario}">
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="paterno" id="txtPaterno" maxlength="50" required="required" placeholder="Apellido Paterno" class="form-control col-xl-8" value="${dto.entidad.paterno}" pattern="[A-Za-zÁÉÍÓÚáéíóú]+"/>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="materno" id="txtMaterno" maxlength="50" required="required" placeholder="Apellido Materno" class="form-control col-xl-8" value="${dto.entidad.materno}" pattern="[A-Za-zÁÉÍÓÚáéíóú]+"/>
                                                                                        <div class="invalid-feedback">Debe ingresar un apellido válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="email" name="email" id="txtCorreo" maxlength="50" required="required" placeholder="correo@ejemplo.com" class="form-control col-xl-8" value="${dto.entidad.email}"/>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="nombreUsuario" id="txtUsuario" maxlength="20" required="required" placeholder="Nombre de Usuario" class="form-control col-xl-8" value="${dto.entidad.nombreUsuario}"/>
                                                                                        <div class="invalid-feedback">Debe ingresar un nombre de usuario</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='password' class='offset-md-3 col-xl-6 col-form-label text-center'>Contraseña</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="password" name="claveUsuario" id="txtPassword" maxlength="20" required="required" placeholder="Contraseña" class="form-control col-xl-8" value="${dto.entidad.claveUsuario}"/>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <select id="tipoUsuario" name="tipoUsuario" class="form-control col-xl-8">
                                                                                                <c:if test="${dto.entidad.tipoUsuario == 'Usuario'}">
                                                                                                <option value="Usuario" selected>Usuario</option>
                                                                                                <option value="Administrador">Administrador</option>
                                                                                                </c:if>
                                                                                                <c:if test="${dto.entidad.tipoUsuario == 'Administrador'}">
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="file" name="archivo" id="txtFile" accept="image/*" required="required" class="form-control col-xl-8" />

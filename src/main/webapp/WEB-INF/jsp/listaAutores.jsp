                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Lista de autores</h1>
                                </div>
                                                        ...
                                                        <table class="table table-striped table-hover table-dark">
                                                                <thead class="bg-info text-light">
                                                                        <tr>
                                                                                ...
                                                                                <th class="text-center align-middle">Paterno</th>
                                                                                <th class="text-center align-middle">Materno</th>
                                                                ...
                                                                <tbody>
                                                                        <c:forEach var="autores" items="${listaAutores}">
                                                                            <tr>
                                                                                    <td class="text-center align-middle"><c:out value="${autores.entidad.idAutor}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${autores.entidad.nombre}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${autores.entidad.paterno}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${autores.entidad.materno}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${autores.entidad.pais}" /></td>
                                                                                    <c:if test="${tipo == 'Administrador'}">
                                                                                    <td class="text-center align-middle">
                                                                                            <a href="mostrarAutor.htm?id=<c:out value="${autores.entidad.idAutor}" />" class="btn btn-outline-success" title="Ver autor"><i class="fas fa-address-card"></i></a>
                                                                                            <a href="actualizarAutor.htm?id=<c:out value="${autores.entidad.idAutor}" />" class="btn btn-outline-warning" title="Actualizar autor"><i class="fa fa-edit"></i></a>
                                                                                            <a href="eliminarAutor.htm?id=<c:out value="${autores.entidad.idAutor}" />" class="btn btn-outline-danger" title="Eliminar autor" onclick="return eliminar()"><i class="fa fa-trash"></i></a>
                                                                                    </td>
                                                                                    </c:if>
                                                                            </tr>
                                                                        </c:forEach>

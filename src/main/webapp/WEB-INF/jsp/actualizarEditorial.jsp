                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Actualizar editorial</h1>
                                </div>
                                        ...
                                        <div class='col-md-12 align-self-center'>
                                                        <form class="needs-validation" novalidate method="post" name="formUsuario" id="formUsuario">
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        <input type="hidden" name="idEditorial" id="id" value="${dto.entidad.idEditorial}">
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="pais" id="txtCorreo" maxlength="50" required="required" placeholder="México" class="form-control col-xl-8" value="${dto.entidad.pais}" pattern="[A-Za-zÁÉÍÓÚáéíóú ]+"/>

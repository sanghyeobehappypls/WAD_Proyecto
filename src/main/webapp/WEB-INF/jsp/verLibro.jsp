                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Datos del libro</h1>
                                </div>
                                                        ...
                                                        <table class='table table-hover table-striped table-dark'>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='id' class='offset-md-3 col-form-label'>ID del libro</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='id' class='col-xl-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.idLibro}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='nombre' class='offset-md-3 col-form-label'>Título</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='nombre' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.titulo}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='nombre' class='offset-md-3 col-form-label'>Edición</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='nombre' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.edicion}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='apPaterno' class='offset-md-3 col-form-label text-right'>Autor</label></h5>
                                                                        </td>
                                                                        <c:forEach items="${listaAutores}" var="autor">
                                                                            <c:if test="${cat.entidad.idAutor == autor.entidad.idAutor}">
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><b><i><label for='apPaterno' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${autor.entidad.nombre} ${autor.entidad.paterno} ${autor.entidad.materno}" /></label></i></b></h5>
                                                                                </td>   
                                                                            </c:if>
                                                                        </c:forEach>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='apPaterno' class='offset-md-3 col-form-label text-right'>Editorial</label></h5>
                                                                        </td>
                                                                        <c:forEach items="${listaEditoriales}" var="editorial">
                                                                            <c:if test="${cat.entidad.idEditorial == editorial.entidad.idEditorial}">
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><b><i><label for='apPaterno' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${editorial.entidad.nombre}" /></label></i></b></h5>
                                                                                </td>   
                                                                            </c:if>
                                                                        </c:forEach>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='apPaterno' class='offset-md-3 col-form-label text-right'>Género</label></h5>
                                                                        </td>
                                                                        <c:forEach items="${listaGeneros}" var="genero">
                                                                            <c:if test="${cat.entidad.idGenero == genero.entidad.idGenero}">
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><b><i><label for='apPaterno' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${genero.entidad.nombre}" /></label></i></b></h5>
                                                                                </td>   
                                                                            </c:if>
                                                                        </c:forEach>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='nombreUsuario' class='offset-md-3 col-form-label text-right'>Número de páginas</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='nombreUsuario' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.npaginas}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='tipoUsuario' class='offset-md-3 col-form-label text-right'>Año de edición</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='tipoUsuario' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.anio}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td colspan='2'>
                                                                                <div class='d-flex flex-xl-row'>
                                                                                        <a href='listaLibros.htm' class='btn btn-lg btn-block btn-outline-primary'>Aceptar</a>
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                        </table>

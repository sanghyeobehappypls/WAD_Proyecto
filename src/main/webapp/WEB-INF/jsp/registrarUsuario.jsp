                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Registrar usuario</h1>
                                </div>
                                <div class="card-body col-md-12 bg-warning">
                                        <div class='row justify-content-center'>
                                                <div class='col-md-12 align-self-center'>
                                                        <form class="needs-validation" novalidate method="POST" name="formUsuario" id="formUsuario" enctype="multipart/form-data">
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="nombre" id="nombre" maxlength="50" required="required" placeholder="Nombre(s)" class="form-control col-xl-8" pattern="[A-Za-zÁÉÍÓÚáéíóú ]+"/>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="paterno" id="paterno" maxlength="50" required="required" placeholder="Apellido Paterno" class="form-control col-xl-8" pattern="[A-Za-zÁÉÍÓÚáéíóú]+" />
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="materno" id="materno" maxlength="50" required="required" placeholder="Apellido Materno" class="form-control col-xl-8" pattern="[A-Za-zÁÉÍÓÚáéíóú]+" />
                                                                                        <div class="invalid-feedback">Debe ingresar un apellido válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='email' class='offset-md-3 col-xl-6 col-form-label text-center'>Correo Electrónico</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="email" name="email" id="email" maxlength="50" required="required" placeholder="correo@ejemplo.com" class="form-control col-xl-8" />
                                                                                        <div class="invalid-feedback">Debe ingresar un correo electrónico válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='nombreUsuario' class='offset-md-3 col-xl-6 col-form-label text-center'>Nombre de Usuario</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="nombreUsuario" id="txtUsuario" maxlength="20" required="required" placeholder="Nombre de Usuario" class="form-control col-xl-8" />
                                                                                        <div class="invalid-feedback">Debe ingresar un nombre de usuario</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='contraseña' class='offset-md-3 col-xl-6 col-form-label text-center'>Contraseña</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="password" name="claveUsuario" id="claveUsuario" maxlength="20" required="required" placeholder="Contraseña" class="form-control col-xl-8" />
                                                                                        <div class="invalid-feedback">Debe ingresar una contraseña</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='tipo' class='offset-md-3 col-xl-6 col-form-label text-center'>Tipo de usuario</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <select id="tipoUsuario" name="tipoUsuario" class="form-control col-xl-8">
                                                                                                <option value="Usuario">Usuario</option>
                                                                                                <option value="Administrador">Administrador</option>
                                                                                        </select>
                                                                                        <div class="invalid-feedback">Debe ingresar un tipo de usuario</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='imagen' class='offset-md-3 col-xl-6 col-form-label text-center'>Foto</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="file" name="archivo" id="archivo" accept="image/*" required="required" class="form-control col-xl-8" />
                                                                                        <div class="invalid-feedback">Debe ingresar una imagen</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td colspan="2">
                                                                                        <div class="sticky-top">
                                                                                                <div class="d-flex flex-xl-row">
                                                                                                        ...
                                                                                                        <div class="p-2 col-xl-6">
                                                                                                                <a href="login.htm" class='btn btn-lg btn-block btn-outline-danger'>Regresar <i class="fas fa-undo"></i></a>
                                                                                                        </div>

                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Datos del préstamo</h1>
                                </div>
                                                        ...
                                                        <table class='table table-hover table-striped table-dark'>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='id' class='offset-md-3 col-form-label'>Usuario</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <c:forEach items="${listaUsuarios}" var="usuarios">
                                                                                    <c:if test="${cat.entidad.idUsuario == usuarios.entidad.idUsuario}">
                                                                                        <h5><b><i><label for='id' class='col-xl-8 col-form-label text-warning text-center text-monospace'><c:out value="${usuarios.entidad.nombre} ${usuarios.entidad.paterno} ${usuarios.entidad.materno}" /></label></i></b></h5>
                                                                                    </c:if>
                                                                                </c:forEach>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='nombre' class='offset-md-3 col-form-label'>Libro</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <c:forEach items="${listaLibros}" var="libros">
                                                                                    <c:if test="${cat.entidad.idLibro == libros.entidad.idLibro}">
                                                                                        <h5><b><i><label for='id' class='col-xl-8 col-form-label text-warning text-center text-monospace'><c:out value="${libros.entidad.titulo}" /></label></i></b></h5>
                                                                                    </c:if>
                                                                                </c:forEach>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='apPaterno' class='offset-md-3 col-form-label text-right'>Fecha de Préstamo</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='apPaterno' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.fechaInicio}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><label for='apMaterno' class='offset-md-3 col-form-label text-right'>Fecha de Entrega</label></h5>
                                                                        </td>
                                                                        <td class='align-middle text-md-center'>
                                                                                <h5><b><i><label for='apMaterno' class='col-md-8 col-form-label text-warning text-center text-monospace'><c:out value="${cat.entidad.fechaTermino}" /></label></i></b></h5>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td colspan='2'>
                                                                                <div class='d-flex flex-xl-row'>
                                                                                        <a href='listaPrestamos.htm' class='btn btn-lg btn-block btn-outline-primary'>Aceptar</a>
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                        </table>

                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Registrar préstamo</h1>
                                </div>
                                <div class="card-body col-md-12 bg-warning">
                                        <div class='row justify-content-center'>
                                                <div class='col-md-12 align-self-center'>
                                                        <form class="needs-validation" novalidate method="POST" name="formPrestamo" id="formPrestamo">
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="number" name="idUsuario" id="nombre" maxlength="50" required="required" placeholder="Nombre(s)" class="form-control col-xl-8" value="${usuario}" readonly="true"/>
                                                                                        <div class="invalid-feedback">Debe ingresar un usuario válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='email' class='offset-md-3 col-xl-6 col-form-label text-center'>Libro</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <select id="idLibro" name="idLibro" class="form-control col-xl-8">
                                                                                                <c:forEach var="libros" items="${listaLibros}">
                                                                                                <option value="${libros.entidad.idLibro}" >${libros.entidad.titulo} </option>
                                                                                                </c:forEach>
                                                                                        </select>
                                                                                        <div class="invalid-feedback">Debe ingresar un libro válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='apMaterno' class='offset-md-3 col-xl-6 col-form-label text-center'>Fecha de Préstamo</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="date" name="fechaInicio" id="materno" required="required" class="form-control col-xl-8" />
                                                                                        <div class="invalid-feedback">Debe ingresar una fecha válida</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td class='align-middle text-md-center'>
                                                                                        <h5><label for='email' class='offset-md-3 col-xl-6 col-form-label text-center'>Fecha de Entrega</label></h5>
                                                                                </td>
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="date" name="fechaTermino" id="email" required="required" class="form-control col-xl-8" />
                                                                                        <div class="invalid-feedback">Debe ingresar una fecha válida</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>

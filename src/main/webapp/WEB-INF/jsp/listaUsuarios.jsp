                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Lista de usuarios</h1>
                                </div>
                                                        ...
                                                        <table class="table table-striped table-hover table-dark">
                                                                ...
                                                                <tbody>
                                                                        <c:forEach var="usuarios" items="${listaUsuarios}">
                                                                            <tr>
                                                                                    <td class="text-center align-middle"><c:out value="${usuarios.entidad.idUsuario}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${usuarios.entidad.nombre}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${usuarios.entidad.paterno}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${usuarios.entidad.materno}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${usuarios.entidad.email}" /></td>
                                                                                    <td class="text-center align-middle"><c:out value="${usuarios.entidad.nombreUsuario}" /></td>
                                                                                    <c:if test="${tipo == 'Administrador'}">
                                                                                    <td class="text-center align-middle">
                                                                                            <a href="mostrarUsuario.htm?id=<c:out value="${usuarios.entidad.idUsuario}" />" class="btn btn-outline-success" title="Ver usuario"><i class="fas fa-address-card"></i></a>
                                                                                            <a href="actualizarUsuario.htm?id=<c:out value="${usuarios.entidad.idUsuario}" />" class="btn btn-outline-warning" title="Actualizar usuario"><i class="fa fa-edit"></i></a>
                                                                                                <a href="eliminarUsuario.htm?id=<c:out value="${usuarios.entidad.idUsuario}" />" class="btn btn-outline-danger" title="Eliminar usuario" onclick="return eliminar()"><i class="fa fa-trash"></i></a>
                                                                                    </td>
                                                                                    </c:if>
                                                                            </tr>
                                                                        </c:forEach>

...
<html>
        <head>
                ...
                <title>Gráfica: Libros x Autor</title>
                        ...
                        <div class="row justify-content-center">
                                <div class="card">
                                        <div class="card-header bg-primary text-light">
                                                <h1 class="text-center text-monospace align-middle">Libros por Autor</h1>
                                        </div>
                                        <div class="card-body bg-warning">
                                                <center><img src="graficaLXA.png" width="650" height="650"/></center>
                                        </div>
                                </div>
                        </div>
                </div>

                ...
                <div class="container-fluid text-monospace">
                        ...
                        <div class="card">
                                <div class="card-header bg-primary">
                                        <h1 class='text-center font-weight-bolder text-light'>Registrar autor</h1>
                                </div>
                                                        ...
                                                        <form class="needs-validation" novalidate method="POST" name="formUsuario" id="formUsuario">
                                                                <table class='table table-hover table-striped table-dark'>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="paterno" id="paterno" maxlength="50" placeholder="Apellido Paterno" class="form-control col-xl-8" pattern="[A-Za-zÁÉÍÓÚáéíóú]+" />
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="materno" id="materno" maxlength="50" placeholder="Apellido Materno" class="form-control col-xl-8" pattern="[A-Za-zÁÉÍÓÚáéíóú]+" />
                                                                                        <div class="invalid-feedback">Debe ingresar un apellido válido</div>
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                                ...
                                                                                <td class='align-middle text-md-left'>
                                                                                        <input type="text" name="pais" id="email" maxlength="50" required="required" placeholder="México" class="form-control col-xl-8" pattern="[A-Za-zÁÉÍÓÚáéíóú ]+" />
